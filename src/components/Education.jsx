  ...
  const educationList = [
    {
      ...
      details: "The M.S. in Business Analytics curriculum has helped me learn to apply modern data science and machine learning capabilities at work to solve real-world business problems."
    },
    {
